...
const makeFive = () => {
	const num = 3;
	const power = 4;
	const sum = Math.pow(num, power);
	resultFive.innerText = sum;
};
...
const makeTwenty = () => {
	const max = Math.max(10, 25, 5, 30, 15);
	resultTwenty.innerText = max;
};
...
const makeTwentyTwo = () => {
	const min = Math.min(10, 25, 5, 30, 15);
	resultTwentyTwo.innerText = min;
};
...
const makeTwentyThree = () => {
	const sum = Math.pow(2, 5);
	resultTwentyThree.innerText = sum;
};
...
const makeTwentyFour = () => {
	const min = Math.min(7, 3, 11, 5, 9);
	resultTwentyFour.innerText = min;
};
...
const makeTwentyFive = () => {
	const max = Math.min(7, 3, 11, 5, 9);
	resultTwentyFive.innerText = max;
};
...
const makeTwentySix = () => {
	...
	resultTwentySix.innerText = random;
};
...
const makeTwentySeven = () => {
	...
	resultTwentySeven.innerText = random;
};
...
const makeTwentyEight = () => {
	const num = Math.ceil(4.47);
	resultTwentyEight.innerText = num;
};
...
const makeTwentyNine = () => {
	...
	resultTwentyNine.innerText = num;
};
